...
const trending = [
  ...
  {
    id:8,
    image:"https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/158024lg1z.jpg?quality=85&auto=webp&optimize={medium}",
    title:"Delightful Daffo...",
  ...
  return (
    <>
      ...
      <div >
        ...
        <div> 
            <img style={{ margin:"auto",width: "80%" ,height:"300px" }} src="https://images.contentstack.io/v3/assets/bltdd99f24e8a94d536/blt66588c77bb87aa3a/640261ad564e5e2df2fa8479/international-womens-day-flowers-zone-10-banner-fy23.jpg?quality=70&auto=webp&optimize={medium}"
            alt="" />
        </div>

        <div  style={{ width: "80%" ,height:"430px",display:"flex" ,margin:"auto",gap:"30px" ,marginTop:"30px"}}>
            <div style={{ width: "60%" ,height:"400px" }}>
                <img style={{ width: "100%" ,height:"400px" }} src="https://images.contentstack.io/v3/assets/bltdd99f24e8a94d536/blt49b91c97b7036f0d/640248e19a3afb6a24eb9b61/spring-bulb-event-tier-fy23.jpg?quality=60&auto=webp&optimize={medium}" alt="" />
            </div>
            <div style={{ width: "60%" ,height:"400px" }}>
                <img style={{ width: "100%" ,height:"400px" }} src="https://images.contentstack.io/v3/assets/bltdd99f24e8a94d536/blt2a3acb7520aca1d9/63f507b6cb0ff166269e7ff9/plant-kween-plant-picks-tier-fy23.jpg?quality=60&auto=webp&optimize={medium}" alt="" />
            </div>
        </div>
      
        <div> 
            <img style={{  margin:"auto",width: "80%" ,height:"300px" }} src="https://i.postimg.cc/rmTz3pcV/Screenshot-379.png"
            alt="" />
        </div>
