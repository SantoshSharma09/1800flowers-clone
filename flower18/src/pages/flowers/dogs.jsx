...
const Plants = ({ Plants }) => {
  ...
  const loadmore = async () => {
    const res = await fetch(
      `https://mock-server-f2z5.onrender.com/dogs?_limit=9&&_start=10`
    );
  ...
  const htol = async () => {
    let res = await fetch(
      `https://mock-server-f2z5.onrender.com/dogs?_sort=price&_order=asc`
    );
  ...
  const ltoh = async () => {
    let res = await fetch(
      `https://mock-server-f2z5.onrender.com/dogs?_sort=price&_order=desc`
    );
    let data = await res.json();
    setPage(data);
  };
