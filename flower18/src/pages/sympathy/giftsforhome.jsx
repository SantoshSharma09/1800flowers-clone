...
const Giftsforhome= ({ data }) => {
  // console.log(proj)
  const [page, setPage] = useState(data);
  const loadmore = async () => {
    const res = await fetch(
      `https://mock-server-f2z5.onrender.com/giftsforhome?_limit=6&&_start=6`
    );
...
export default Giftsforhome;


export async function getStaticProps() {
  let res = await fetch(
    `https://mock-server-f2z5.onrender.com/giftsforhome?_limit=6`
  );
